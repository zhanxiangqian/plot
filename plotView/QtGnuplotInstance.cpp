...
QtGnuplotInstance* QtGnuplotInstance::instance = NULL;

QtGnuplotInstance* QtGnuplotInstance::getInstance(QString gnuplotPath)
{
	if (instance == NULL)
	{
		...
		{
			instance = new QtGnuplotInstance(NULL, gnuplotPath);
		}
	}
	return instance;
}
